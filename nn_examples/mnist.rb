...
mnist_images_file = 'nn_examples/mnist/train-images-idx3-ubyte.gz'
mnist_labels_file = 'nn_examples/mnist/train-labels-idx1-ubyte.gz'
...
# ImageGrid.new(nn.weights[1]).to_file 'nn_examples/mnist/hidden_weights.png'
