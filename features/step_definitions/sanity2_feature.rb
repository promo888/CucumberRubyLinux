...
Given /^Code Tested2$/  do
  ...
  fann.train_on_data(train, 1000, 20, 0.002) # 1000 max_epochs, 10 errors between reports and 0.1 desired MSE (mean-squared-error)
  ...
  fann.train_on_data(train, 100, 10, 0.002)
...
Epochs            1. Current error: 0.0733333007. Bit fail 0.
Epochs           10. Current error: 0.0026936561. Bit fail 0.
Epochs           20. Current error: 0.0025214723. Bit fail 0.
Epochs           30. Current error: 0.0025000230. Bit fail 0.
Epochs           40. Current error: 0.0024879309. Bit fail 0.
Epochs           50. Current error: 0.0024654362. Bit fail 0.
Epochs           59. Current error: 0.0019618918. Bit fail 0.
Max epochs    10000. Desired error: 0.0020000001.
Epochs            1. Current error: 0.0017666821. Bit fail 0.


  0m0.043s
  Max epochs     1000. Desired error: 0.1000000015.
  Epochs            1. Current error: 0.0549894162. Bit fail 0.
  Max epochs    10000. Desired error: 0.0099999998.
  Epochs            1. Current error: 0.0213634185. Bit fail 0.
  Epochs            2. Current error: 0.0025007059. Bit fail 0.


Max epochs     1000. Desired error: 0.1000000015.
Epochs            1. Current error: 0.0515302420. Bit fail 0.
Max epochs    10000. Desired error: 0.0099999998.
Epochs            1. Current error: 0.0213228129. Bit fail 0.
Epochs            2. Current error: 0.0028754869. Bit fail 0.
...
Given /^Code Tested3$/  do

#!/usr/bin/env ruby

  require_relative Dir.getwd+'/neural_net'
  require 'csv'

# Dataset available at https://archive.ics.uci.edu/ml/datasets/Auto+MPG
  rows = CSV.read "nn_examples/auto-mpg.data", col_sep: ' '
...
# puts "\nUntrained test nn_examples (first 10):"
...
# puts result
  ...
  puts "\nTrained test nn_examples (first 10):"
  show_examples.(nn, x_test, y_test)
