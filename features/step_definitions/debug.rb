...
######### Martin Start
$lot_start_size = 1
$lot_multiplier = 3 #2 #ToDo  Reinvest = $lot_start_size+1
...
$max_position_lots_size = 10 #TODO optimize for faster execution+below row
...
def createTrade(barDateTime,orderType,price,qty,positionStatus,barHigh,barLow,indicatorsValues)
   ...
   if(positionStatus.to_s.downcase.include?('open') || positionStatus.to_s.downcase.include?('opposite opening'))
     ...
     $lot_multiplier = 3 #TODO INITIAL_LOTS_MULTIPLIER
   end
