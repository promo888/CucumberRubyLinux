...
=end
  ...
  profit_trades.each{|bar|  $source_hash[bar[1]-1][BUY_FIELD] = bar[0][CLOSE_FIELD].to_f   } #Profit trades in Green
  ...
  loss_trades.each{|bar|  $source_hash[bar[1]-1][SELL_FIELD] = bar[0][CLOSE_FIELD].to_f   } #Loss trades in Red
